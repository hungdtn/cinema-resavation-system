...
public class PhimController {
    ...
    @GetMapping
    public ResponseEntity<List<PhimResponseDto>> getAll() {
        return ResponseEntity.ok(phimService.getAll());
    }


    @GetMapping("/{id}")
    public ResponseEntity<PhimResponseDto> getById(@PathVariable Integer id) {
    ...
    public ResponseEntity<?> create(@RequestPart("phim") String phimJson,
        ...
        try {
            PhimRequestDto dto = objectMapper.readValue(phimJson, PhimRequestDto.class);
            return ResponseEntity.ok(phimService.create(dto, poster, banner));
    ...
    @GetMapping("/filter")
    public ResponseEntity<List<PhimResponseDto>> filter(@RequestParam(required = false) String theLoai,
                                                        @RequestParam(required = false) Enum.TrangThaiPhim trangThai) {
